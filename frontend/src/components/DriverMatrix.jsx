...
// d3.scaleBand para la cuadrícula, una sola escala secuencial
// (d3.interpolateRdYlGn, invertida) para todas las celdas -> rojo = condición
// menos favorable, verde = más favorable, igual que el semáforo del resto
// del producto. Un patrón SVG a rayas marca las celdas SIN_DATO (para no
// confundir "falta el dato" con "el driver vale 0").
//
...
export default function DriverMatrix({ data = [], onSelect }) {
  ...
  useEffect(() => {
    ...
    // Rojo (condición menos favorable) -> amarillo -> verde (más favorable)
  ...
  return (
    <div ref={wrapRef}>
      ...
      <div className="flex items-center gap-2 mt-3 text-xs" style={{ color: "var(--color-ink-faint)" }}>
        <span>Condición menos favorable</span>
        <div style={{ width: 100, height: 8, borderRadius: 4, background: "linear-gradient(90deg, #d73027, #fee08b, #1a9850)" }} />
