...
| [Como_Funciona_Preview.png](Como_Funciona_Preview.png) / [.html](Como_Funciona_Preview.html) | Borrador de identidad para la superficie *Cómo funciona* del Equipo 1 (`US-601`, `PLAN_TRABAJO.md` §5.bis). No es un octavo mockup formal — esa superficie no lo necesita según el plan |
