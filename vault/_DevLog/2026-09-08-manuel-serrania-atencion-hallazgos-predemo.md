...
agent: "OpenCode"
model: "big-pickle"
session_duration: "1 sesión — atender los hallazgos de la QA pre-demo que tocan a C2: formalizar dueño/reviewer de BUG-064/066, registrar las deudas BUG-070/071, preparar el código inerte del formato `porcentaje_3` (0.015% visible) y dar acuse de recibo de US-305; sincronización de la rama con `main` al arrancar; renumeración de las deudas a BUG-072/073 por colisión de IDs (DEC-013 - PR #290)"
touches: ["US-203", "US-204", "US-212", "US-213", "US-207", "US-526", "US-006", "US-305", "REQ-002", "BUG-064", "BUG-066", "BUG-072", "BUG-073"]
...
→ [[vault/_DevLog/_index|Volver al índice]] · [[vault/06_Quality_Testing/Bug_Register|Bug Register]] · [[vault/06_Quality_Testing/QA_Logs/2026-09-07-oscar-quiroz-qa-pre-demo|QA Óscar (BUG-064/066)]] · [[vault/06_Quality_Testing/QA_Logs/_index|QA Logs (Diana: BUG-072/073)]]
...
## Colisión de IDs resuelta (DEC-013 → renumeración)

Al sincronizar con `main` (merge del PR #290) las deudas de esta sesión chocaron con IDs que el PM ya había escrito en `main`: **BUG-070** = refresco de token nunca desplegado (Karla/Edgar) y **BUG-071** = páginas internas sin guarda de sesión (Karla/Edgar, dueño C2). Regla DEC-013: quien llega segundo renumera. Las deudas de C2 pasan a **BUG-072** (formato "0.0%") y **BUG-073** (CCTs de ejemplo del Panel ML). El registro queda con las filas del PM como BUG-070/071 y las de esta sesión como BUG-072/073.
...
## BUG-072 (nueva deuda 🟢) — "% escuelas en riesgo" marca "0.0%"
...
## BUG-073 (nueva deuda 🟢) — Panel ML: CCTs de ejemplo ajenos al par de la demo
...
- Texto Panel ML (BUG-073), ejes de DB-01/04/05 (BUG-064/066): post-9.
