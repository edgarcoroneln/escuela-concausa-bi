...
traces_up: ["REQ-001", "vault/01_Product/PRD"]
...
> Implementa **REQ-001** ([[vault/02_Requirements/Requirements_Detailed]]). Fuentes: [[vault/14_Data_Sources/_index]].
...
> `vault/04_UX_Design/Cube_Specs_DB05_DB08.md` §8.1) el 22 ago 2026; decisión de esquema tomada por
...
> en [[vault/03_Architecture/Data_Lineage_US106|Data_Lineage_US106]].
