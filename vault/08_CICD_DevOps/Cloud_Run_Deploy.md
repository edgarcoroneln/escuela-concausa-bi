...
- `--set-secrets=...`: `JWT_SECRET_KEY` y `POSTGRES_PASSWORD` se inyectan desde Secret
  ...
  de `vault/07_Security/Secrets_Policy.md`).
...
[[vault/_DevLog/2026-08-29-luis-tellez-us505-fase2-gold-cloudsql-redeploy]].
...
a la imagen. Detalle en [[vault/_DevLog/2026-08-29-luis-tellez-bug025-redeploy-agente-prod]].
...
- [[vault/03_Architecture/System_Design]] — Diseño completo del sistema
