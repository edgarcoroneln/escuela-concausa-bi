...
| SEC-006 | `AUTH_LECTURA_PUBLICA=true` en el entorno desplegado: la lectura no exige sesión | low | resolved | 2026-09-02 | Flip `AUTH_LECTURA_PUBLICA=false` en Cloud Run (rev `faro-api-00012-pq5`, 2026-09-05) tras validar el login e2e (`BUG-046`); env-var, sin rebuild, reversible — C5. Verificado en vivo sin token: lectura/predicciones/agente 200→401, `admin/*` sin cambio, públicos intactos. Ver [[vault/_DevLog/2026-09-05-luis-tellez-sec006-flip-auth-lectura-publica]] | ☑ |
