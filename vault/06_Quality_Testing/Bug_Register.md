...
| BUG-048 | **Producción sirve un Gold empobrecido: `indice_completitud_drivers` 0.197 y `escuelas_en_riesgo` 0, contra un pipeline local con drivers completos y salidas ML defendibles.** El snapshot importado a Cloud SQL se generó antes de BUG-045; el código desplegado era correcto y los datos estaban viejos. **Actualización C3 2026-09-05:** el dump post-BUG-045 de C1 trae 136,046 features/3 ciclos, D3/D4 ~83 % y ocho cubos, pero salidas ML antiguas (98.9 % en riesgo, cero recomendaciones vigentes). El rerun temporal robusto produjo 45,276 predicciones, 45,276 recomendaciones de cinco drivers y 214 escuelas (0.47 %) sobre el umbral; el dump final restaurado desde cero conserva ocho materialized views y 44,108 recomendaciones visibles en el universo observado. | **high** | open | US-113 / US-302 / US-311 / US-313 / US-505 / REQ-001 / REQ-003 / REQ-005 / DS-07 | **C1 ✅** Gold post-BUG-045 entregado. **C3 ✅** ML-01 con `loss="absolute_error"` mejora MAE temporal 11.04 % sobre baseline; ML-02 F1 0.8331; dump `gold_bug048_final_2026-09-05.sql` generado y restaurado de prueba. **Pendiente C5:** backup, importación a Cloud SQL, validación read-only y Superset. | `tests/test_entrenar_ml01.py` 34 passed · `tests/test_publicar_gold.py` 39 passed · dbt 158/159 (único desfase: 1,168 recomendaciones de features fuera de `fact_escuela_ciclo`, visible y no ocultado) · restauración aislada: 45,276 predicciones, 45,276 recomendaciones, cinco drivers, ocho cubos, riesgo 0.0106–0.8744 |
