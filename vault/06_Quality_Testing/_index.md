...
| [[vault/06_Quality_Testing/QA_team_documentation/Reporte_Auditoria_QA_UX]] | Estrategia operativa de QA para S7 (Edward Ruiz): modelo de "Owner Checks" para el equipo de 3, matriz de perspectivas (datos, funcional E2E, UX/storytelling) y criterios de liberación Go/No-Go |
