...
| `US-422` | Célula 4 | Escribir pruebas unitarias y de integración de la API | Eloisa González Rubio |
...
| `US-423` | Célula 4 | Pruebas de seguridad de la autenticación | Eloisa González Rubio |
